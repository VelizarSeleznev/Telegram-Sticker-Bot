...
- `GEMINI_API_KEY` - обязательный Google AI API key для Gemma 4
- `EMOJI_VISION_MODEL` - vision-модель автоэмодзи, по умолчанию `gemma-4-26b-a4b-it`
- `EMOJI_VISION_TIMEOUT_SECONDS` - максимальное ожидание Gemma, по умолчанию `30`
- `EMOJI_VISION_MAX_OUTPUT_TOKENS` - лимит JSON-ответа, по умолчанию `192`
