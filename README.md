...
- Изображения и импортируемые static-стикеры: `fit` на прозрачный холст `512x512` -> `webp`, попытка ужать до лимита static sticker; `center crop` до квадрата доступен кнопкой на шаге выбора эмодзи для новых изображений.
